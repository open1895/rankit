    ...
    <>
      ...
      >
        <div className="container max-w-3xl mx-auto px-3">
          <nav className="flex items-center justify-around gap-1 py-2">
            {tabs.map(({ to, icon: Icon, label }) => {
              ...
              return (
                <button
                  ...
                  aria-label={label}
                  className={`flex-1 flex flex-col items-center justify-center gap-0.5 py-1.5 rounded-xl transition-all duration-200 min-h-[56px] ${
                ...
                >
                  ...
                  <span className={`text-[11px] leading-tight ${active ? "font-bold" : "font-semibold"}`}>
                    {label}
                  </span>
                </button>
              );
